            ...
            {loading ? (
              ...
              <div className="space-y-8">
                {filteredItinerary.map((item, index) => (
                  <div key={item.id} className="relative pl-10 transition-all duration-700 hover:-translate-y-0.5">
                    ...
                    <div className="rounded-dalat border border-white/25 bg-white/55 p-6 shadow-[0_10px_26px_rgba(74,74,74,0.09)] backdrop-blur-md">
