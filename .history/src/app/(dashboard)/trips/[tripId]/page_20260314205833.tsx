  ...
  return (
    <main className="relative min-h-screen space-y-5 overflow-hidden bg-[#FDFCFB] px-3 pb-[calc(7.25rem+env(safe-area-inset-bottom))] pt-4 sm:space-y-8 sm:p-6 md:space-y-10 md:p-10">
      ...
      <section className="relative z-[2] space-y-6">
        ...
        <div className="animate-fade-up rounded-dalat border border-white/30 bg-white/60 p-3 shadow-[0_10px_24px_rgba(74,74,74,0.07)] backdrop-blur-xl [animation-delay:340ms]">
          <p className="mb-2 text-[11px] uppercase tracking-wide text-[#4A4A4A]/70">Thao tác nhanh · 1 chạm</p>
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            <button
              type="button"
              onClick={() => handleScrollToSection('weather-hub')}
              className="inline-flex min-h-[42px] items-center justify-center gap-1.5 rounded-full border border-white/35 bg-white/75 px-3 py-2 text-[11px] text-[#4A4A4A] transition hover:bg-white"
            >
              <CloudDrizzle className="h-3.5 w-3.5 text-pine" />
              Thời tiết
            </button>
            <button
              type="button"
              ...
              className="inline-flex min-h-[42px] items-center justify-center gap-1.5 rounded-full border border-white/35 bg-white/75 px-3 py-2 text-[11px] text-[#4A4A4A] transition hover:bg-white"
            >
              <Compass className="h-3.5 w-3.5 text-pine" />
              Timeline
            </button>
            <button
              type="button"
              ...
              className="inline-flex min-h-[42px] items-center justify-center gap-1.5 rounded-full border border-white/35 bg-white/75 px-3 py-2 text-[11px] text-[#4A4A4A] transition hover:bg-white"
            >
              <MapPinned className="h-3.5 w-3.5 text-pine" />
              Bản đồ
            </button>
            <button
              type="button"
              ...
              className="inline-flex min-h-[42px] items-center justify-center gap-1.5 rounded-full bg-pine px-3 py-2 text-[11px] font-medium text-white transition hover:opacity-90"
            >
