          ...
          <CardContent className="space-y-3">
            {loading ? (
              ...
              <div className="flex min-h-56 flex-col items-center justify-center rounded-xl border border-dashed border-mist-gray bg-white/60 p-6 text-center backdrop-blur-sm">
                ...
                <p className="mt-3 text-sm font-medium text-slate-700">Hôm nay chú gấu ngủ nướng vì bạn chưa có lịch trình nào.</p>
                <p className="mt-1 text-xs text-slate-500">Thêm điểm đến để timeline bắt đầu sống động hơn.</p>
              </div>
            ) : (
              itinerary.map((item) => (
                <ItineraryItem
