...
export default function TripDashboardPage({ params }: PageProps) {
  ...
  return (
    <main className="relative min-h-screen space-y-10 overflow-hidden bg-[#FDFCFB] p-8 md:p-10">
      <div className="pointer-events-none absolute -left-20 top-10 h-72 w-72 rounded-full bg-rose/20 blur-3xl" />
      <div className="pointer-events-none absolute right-0 top-28 h-80 w-80 rounded-full bg-pine/15 blur-3xl" />

      <header className="relative space-y-3 transition-all duration-700">
        <p className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/55 px-4 py-1.5 text-xs text-pine backdrop-blur-md">
          <Sparkles className="h-3.5 w-3.5" strokeWidth={1.5} />
          Dalat Dream Dashboard
        </p>
        <h1 className="text-4xl leading-tight text-[#4A4A4A] md:text-6xl" style={{ fontFamily: 'var(--font-heading), serif' }}>
      ...
      <div className="relative grid grid-cols-1 gap-10 xl:grid-cols-3">
        <Card id="weather-hub" className="weather-hub bg-white/40 backdrop-blur-xl border border-white/20 rounded-dalat shadow-[0_16px_48px_rgba(74,74,74,0.08)] transition-all duration-700 xl:col-span-1">
        ...
        <Card className="bg-white/40 backdrop-blur-xl border border-white/20 rounded-dalat shadow-[0_16px_48px_rgba(74,74,74,0.08)] transition-all duration-700 xl:col-span-1">
          <CardHeader className="p-8">
