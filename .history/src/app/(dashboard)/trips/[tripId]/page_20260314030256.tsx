      ...
      <div className="relative grid grid-cols-1 gap-6 sm:gap-8 xl:grid-cols-3 xl:gap-10">
        ...
        <Card className="animate-fade-up bg-white/40 backdrop-blur-xl border border-white/20 rounded-dalat shadow-[0_16px_48px_rgba(74,74,74,0.08)] transition-all duration-700 [animation-delay:220ms] xl:col-span-1">
          ...
          <CardContent className="space-y-5 p-5 pt-0 sm:space-y-6 sm:p-8 sm:pt-0">
            <form onSubmit={handleAddCustomStop} className="animate-fade-up grid grid-cols-1 gap-2 rounded-dalat border border-white/25 bg-white/55 p-3 sm:grid-cols-2 sm:p-4 [animation-delay:140ms]">
              <input
              ...
              <input
                ...
                className="sm:col-span-2 rounded-xl border border-white/40 bg-white/70 px-3 py-2 text-xs outline-none"
              />
              <input
                type="time"
              ...
              <textarea
                ...
                className="sm:col-span-2 h-16 rounded-xl border border-white/40 bg-white/70 px-3 py-2 text-xs outline-none"
              />
              <button type="submit" className="sm:col-span-2 rounded-full bg-pine px-4 py-3 text-xs font-medium text-white transition hover:opacity-90">
