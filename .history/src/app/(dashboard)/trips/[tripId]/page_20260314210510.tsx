        ...
        >
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 ml-6.5 text-xs text-[#4A4A4A]/85 sm:text-sm">{weatherAlert.message}</p>
            </div>

            <button
              type="button"
              onClick={() => setIsWeatherAlertExpanded((previous) => !previous)}
              className="inline-flex shrink-0 items-center gap-1 whitespace-nowrap rounded-full border border-white/35 bg-white/70 px-2.5 py-1 text-[11px] leading-none text-[#4A4A4A]/80 transition hover:bg-white"
            >
              Chi tiết
