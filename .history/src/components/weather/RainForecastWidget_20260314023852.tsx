...
export function RainForecastWidget({
  ...
  return (
    ...
    >
      ...
      {chartData.length > 0 && (
        <div className="rounded-2xl border border-mist/80 bg-white/65 p-4 backdrop-blur-sm">
      ...
      {forecasts.length === 0 ? (
        ...
        <ul className="space-y-2 rounded-2xl border border-white/25 bg-white/55 p-4 text-sm text-[#4A4A4A]/85">
          {forecasts
      ...
      {hasHighRain && (
        <div className="rounded-2xl border border-pine/30 bg-white/60 p-4 text-sm text-[#4A4A4A]/80">
