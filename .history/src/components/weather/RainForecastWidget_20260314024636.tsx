...
export function RainForecastWidget({
  ...
  return (
    ...
    >
      ...
      {chartData.length > 0 && (
        <div className="animate-fade-up rounded-dalat border border-white/30 bg-white/65 p-4 shadow-[0_10px_26px_rgba(74,74,74,0.07)] backdrop-blur-sm [animation-delay:120ms]">
      ...
      {forecasts.length === 0 ? (
        ...
        <ul className="animate-fade-up space-y-2 rounded-dalat border border-white/25 bg-white/60 p-4 text-sm text-[#4A4A4A]/85 shadow-[0_8px_20px_rgba(74,74,74,0.06)] [animation-delay:220ms]">
          {forecasts
