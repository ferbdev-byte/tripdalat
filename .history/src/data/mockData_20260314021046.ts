...
export const mockData = {
  ...
  weather: [
    { hour: '04', rainProbability: 44, humidity: 95, cloudCover: 86, windSpeed: 7 },
    { hour: '05', rainProbability: 49, humidity: 94, cloudCover: 91, windSpeed: 6 },
    { hour: '06', rainProbability: 53, humidity: 92, cloudCover: 89, windSpeed: 8 },
    { hour: '09', rainProbability: 34, humidity: 82, cloudCover: 66, windSpeed: 11 },
    { hour: '12', rainProbability: 57, humidity: 77, cloudCover: 68, windSpeed: 13 },
    { hour: '15', rainProbability: 76, humidity: 85, cloudCover: 88, windSpeed: 10 },
    { hour: '18', rainProbability: 71, humidity: 88, cloudCover: 92, windSpeed: 9 },
    { hour: '20', rainProbability: 64, humidity: 90, cloudCover: 95, windSpeed: 8 },
  ] as WeatherPoint[],
};
